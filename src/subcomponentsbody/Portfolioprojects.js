      ...
      <div className="portcontainer">
        ...
        <div className="portbox">
          ...
          <div className="portlayer">
            <h3>NexaHub</h3>
            <p>
              This is Note's Website.All Notes are store in Cluster From .
            </p>
         ...
         <div className="portbox">
          ...
          <div className="portlayer">
            <h3>Live Chat Application</h3>
            <p>
            💬 Developed a real-time chat application using MERN Stack and Socket.io, enabling seamless, secure, and instant messaging for 500+ users.
            </p>
            <a href="https://github.com/manya3219/Live-chat-Application">
              <i className="bx bx-link-external" />
            </a>
          </div>
        </div>
